...
/* 1W通用双LED控制板（聚光+泛光），带NTC温控 */
#define BOARD_TYPE_CORE_1W 3
/* 5W通用双LED控制板（聚光+泛光），带NTC温控 */
#define BOARD_TYPE_CORE_5W 4

/* 选择硬件  */
#ifndef CONFIG_BOARD_TYPE
#define CONFIG_BOARD_TYPE BOARD_TYPE_CORE_5W
#endif
...
CONFIG_DIM_LINEAR: 使能线性DIM调光，0-调光叠加到vfb上，需要非线性修正；1-调光线性控制电流
...
#elif CONFIG_BOARD_TYPE == BOARD_TYPE_CORE_1W
#define CONFIG_LED_EN (CONFIG_LED_FOCUS | CONFIG_LED_WIDE)
#define CONFIG_FOCUS_LV_MAX 31
#define CONFIG_FOCUS_FLASH_LV_MAX 32
#define CONFIG_WIDE_LV_MAX 32
...
#define CONFIG_DIM_LINEAR 0
#define CONFIG_NTC_EN NTC_TO_GND
#elif CONFIG_BOARD_TYPE == BOARD_TYPE_CORE_5W
#define CONFIG_LED_EN (CONFIG_LED_FOCUS | CONFIG_LED_WIDE)
#define CONFIG_FOCUS_LV_MAX 32
#define CONFIG_FOCUS_FLASH_LV_MAX 32
#define CONFIG_WIDE_LV_MAX 32
#define CONFIG_DIM_HIGH_RES 0
#define CONFIG_DIM_LINEAR 1
#define CONFIG_NTC_EN NTC_TO_GND
#else
